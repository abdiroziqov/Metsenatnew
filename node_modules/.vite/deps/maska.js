...
var b = (n, t, s) => t in n ? L(n, t, { enumerable: true, configurable: true, writable: true, value: s }) : n[t] = s;
...
var x = (n) => n.startsWith("[") && n.endsWith("]") ? C(n) : n;
var J = (n) => {
  ...
  constructor(t, s = {}) {
    ...
    m(this, "inputEvent", (t2) => {
      ...
      if (e.isEager()) {
        ...
        k === "" && "data" in t2 && t2.data != null ? l = t2.data : (r.startsWith(a) || e.completed(k)) && (l = k);
      }
      this.setMaskedValue(s2, l), "inputType" in t2 && (t2.inputType.startsWith("delete") || i != null && i < a.length) && s2.setSelectionRange(i, c);
    });
